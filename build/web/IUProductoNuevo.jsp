...
<html>
    ...
    <body class="theme-dark" id="body">
        ...
        <main class="l-admin" id="admin">
            ...
            <% ProductoPresentador proPre = (ProductoPresentador) session.getAttribute("proPre"); %>
                        ...
                        <div class="container-fluid">
                            <div class="row mx-1">
                                <div class="col-12 mt-3">
                                    <h4>
                                        <% String tipoAccion = proPre.getTipoAccion(); %>
                                        <%= tipoAccion %> Producto 
                                    </h4>
                                </div>
                                ...
                                <div class="col-md-8 mt-3">
                                        <div class="my-card">
                                                ...
                                                <% Object[]productoDB = proPre.getProducto(); %>

                                                <input name="IdProducto" type="hidden" value="<%= productoDB[0]%>" />

                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="formGroupExampleInput" for="user">Producto</label>
                                                            <input id="producto" name="producto" type="text" value="<%= productoDB[1] %>" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="formGroupExampleInput" for="user">Precio</label>
                                                            <input id="producto" name="precio" type="text" value="<%= productoDB[2] %>" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="formGroupExampleInput" for="user">Cantidad</label>
                                                            <input id="producto" name="cantidad" type="text" value="<%= productoDB[3] %>" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>

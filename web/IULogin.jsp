<%-- 
    Document   : IULogin
    Created on : 28/11/2021, 10:38:19 AM
    Author     : josec
--%>
...
<html>
    <head>
        ...
        <title>Login | Sistema web para llevar el control de ventas de la empresa - COMPSELL S.R.L</title>
    ...
    <body class="theme-light" id="body">
        ...
        <main class="l-auth">
            ...
            <section class="l-auth__hero">
                ...
                <article class="l-auth__hero-top-left"> <img src="./assets/img/login/login.png"> </article>
            ...
            <section class="l-auth__content">
                ...
                <article>
                    ...
                    <aside>
                        ...
                        <img src="./assets/img/login/laptop.png" alt="laptop">
                    </aside>

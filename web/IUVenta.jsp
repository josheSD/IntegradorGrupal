                        ...
                        <div class="row mx-1">
                            <div class="col-12 mt-3">
                                ...
                                <form method="post" action="VentaControl">
                                    <button class="btn btn-primary my-3" type="submit" name="acc" value="AgregarVenta">
                                        Agregar
                                    </button>
                                </form>
                            </div>
                            ...
                            <div class="col-12 mt-3">
                                <div class="table-responsive">
                                    <table class="table table-bordered my-table">
                                        ...
                                        <tbody>
                                                <% for(int i=1;i<ventPre.getListaVenta().size();i++){ %>
                                                <% Object[] ventaLista = (Object[])ventPre.getListaVenta().get(i); %>
                                                  <tr>
                                                    <td>
                                                        <form method="post" action="VentaControl">
                                                            
                                                            <input type="hidden" name="IdVenta" value="<%= ventaLista[0] %>" />
                                                            <input type="hidden" name="Serie" value="<%= ventaLista[1] %>" />
                                                            <input type="hidden" name="Estado" value="<%= ventaLista[2] %>" />
                                                            <input type="hidden" name="Senior" value="<%= ventaLista[3] %>" />
                                                            <input type="hidden" name="Dni" value="<%= ventaLista[4] %>" />
                                                            <input type="hidden" name="Direccion" value="<%= ventaLista[5] %>" />
                                                            <input type="hidden" name="Telefono" value="<%= ventaLista[6] %>" />
                                                            <input type="hidden" name="Total" value="<%= ventaLista[7] %>" />
                                                            <input type="hidden" name="FechaRegistro" value="<%= ventaLista[8] %>" />
                                                            <input type="hidden" name="FechaActualizacion" value="<%= ventaLista[9] %>" />
                                                            <input type="hidden" name="IdUsuario" value="<%= ventaLista[10] %>" />
                                                            
                                                            <button class="btn btn-success" type="submit" name="acc" value="ModificarVenta">
                                                                <i class="fas fa-pencil-alt fa-xs"></i>
                                                            </button>
                                                            <button class="btn btn-danger" type="submit" name="acc" value="EliminarVenta">
